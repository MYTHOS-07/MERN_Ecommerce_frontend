...
const ForgetPasswordPage = () => {
  ...
  return (
    <div className="flex items-center justify-center md:w-lg px-4 py-10 bg-white dark:bg-slate-900 rounded-2xl mt-30 md:m-auto md:mx-30 md:my-20  dark:text-white">
